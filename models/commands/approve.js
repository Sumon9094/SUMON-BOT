...
const dataPath = __dirname + "/SAGOR/approvedThreads.json";
const dataPending = __dirname + "/SAGOR/pendingdThreads.json";
const fs = require("fs");
...
module.exports.run = async ({ event, api, args, Threads, handleReply, Users }) => {
  ...
  const cre = this.config.credits
    ...
    else api.sendMessage("[ OK ] ✨ApKa Group Approved 🙌.\n 🖤So Enjoy\n\n 💝🥀OWNER:- ☞MOHAMMAD SAGOR☜ 💫\n 🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 SAGOR🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ https://www.facebook.com/profile.php?id=61573038178753\n👋For Any Kind Of Help Contact On Telegram  Username 👉 @xxFUCKyouBRO😇", idBox, (error, info) => {
