...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#FFF"
    ctx.fillText("SaGor", canvas.width /  2 - 660, 1600);
    ctx.save();
    ctx.font = "350px Grandstander";
    ctx.fillStyle = "#000"
    ctx.fillText("SaGor", canvas.width / 2 - 660, 1000);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("anupx3aliya", 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("anup.x3", 1600, 3150);
    ctx.fillStyle = "#000"
   ctx.fillText("rude larkaw", 2000, 3600);
    ctx.beginPath();
