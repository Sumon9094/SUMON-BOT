...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("আপনি কার আম্মুকে ভালবাসতে চান এমন 1 জনকে @ম্যানশন করতে হবে", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("আমি সাগর করলাম শুরু তর আম্মুর ভুদায় দিব হাত");
setTimeout(() => {a({body: "খাংকির পোলা তর মারে চুদে সাগর 🥰।" + " " + name, mentions: arraytag})}, 3000);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি সাগর তর বাপ মাগির ছেলে 😘।" + " " + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body: "DNA টেষ্ট করা দেখবি সাগর এর চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 75000);
...
setTimeout(() => {a("~সাগর এর জারজ শন্তান🤖")} , 93000);
...
setTimeout(() => {a({body: "Hi সাগর এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "DNA টেষ্ট করা দেখবি সাগর এর চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 156000);
...
setTimeout(() => {a({body: "Hi সাগর এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a("~ সাগর এর ফাটা কন্ডমের ফসল। জা ভাগ🤖")} , 39000);
setTimeout(() => {a({body: "Welcome শুয়োরের বাচ্চা 🥰।" + " " + name, জঅয়: arraytag})}, 3000);
...
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ সাগর এর পুত। জা ভাগ🤖")} , 39000);
